...
- [x] Release [Modelscope demo pace](https://www.modelscope.cn/studios/Damo_XR_Lab/LAM-A2E). You can try the demo our pull the demo source code to deploy on your own machine.
